...
#fd1, x_rec1, y_rec1 = get_FD_abs(a, b, order = 10, norm = True, no_zeroth = False)
#fd2, x_rec2, y_rec2 = get_FD_abs(c, d, order = 10, norm = True, no_zeroth = False)
#fd3, x_rec3, y_rec3 = get_FD_abs(e, f, order = 10, norm = True, no_zeroth = nFalse)
